...
- [x] **Phase 10: Battle & Capture** — Seeded battleEngine, captureService, IV + starter, collection view (vertical loop đầu tiên) (completed 2026-08-14)
- [x] **Phase 11: Progression, Chemistry & Economy Depth** — Dupe → hồn ngọc, evolution, shop + items, legion battle 3+9 (completed 2026-08-18)
...
- [x] 09-04-PLAN.md — Encounter system: position-blended roll engine (crypto RNG) + sanguoTickEncounters cron + ~20/hr sliding-window cap + boss sub-roll + encounter embed (TQC-08)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 09-05-PLAN.md — Integration: [BLOCKING] migration 0018 + D-20 reseed + ROADMAP SC1/SC2/Goal amendments + economy-budget re-sign flag + phase gate (TQC-06..09)
...
**Plans**: 6/7 plans executed — planned 2026-08-13
Plans:
**Wave 1**

- [x] 10-01-PLAN.md — Seeded battle engine (tracer): pure-rand + runBattle (D-05/D-06) + replay tests (TQC-10)
- [x] 10-02-PLAN.md — Schema migration 0019: heroes base stats/rarity/tier, user_heroes HP/zone, sanguo_battles replay record, capture_attempts + user_sanguo_state + [BLOCKING] migrate (TQC-10..13)
- [x] 10-03-PLAN.md — D-20 economy re-sign + CAPTURE_TIERS constants (checkpoint:decision, one-way gate) (TQC-11)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 10-04-PLAN.md — Content seed: sanguo-base-stats.json (132 heroes + 6 starters) + idempotent upsert (TQC-12)
- [x] 10-05-PLAN.md — battleCheckInService + captureService + boss templates + audit/pity/flee + replay roundtrip tests (TQC-11)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 10-06-PLAN.md — Battle/capture UI: battle log + capture embeds, buttons, spar command, ack→battle inversion, routing (TQC-10/11)
...
**Plans**: 8/8 plans executed planned (2026-08-14)
Plans:
**Wave 1**

- [x] 11-01-PLAN.md — [BLOCKING] Economy amendment (checkpoint:decision, D-18) + schema migration 0020 (5 new tables + 4 extends) + [BLOCKING] migrate (TQC-14..17)
...
- [x] 11-07-PLAN.md — Legion assembly command + /sanguo heroes SC5 filters (faction/IV) (TQC-17)

**Wave 7** *(blocked on Wave 6)*

- [x] 11-08-PLAN.md — Balance pass + economy compliance verification + i18n parity + full regression (TQC-14..17)
...
| 11. Progression, Chemistry & Economy Depth | 8/8 | Complete    | 2026-08-18 |
