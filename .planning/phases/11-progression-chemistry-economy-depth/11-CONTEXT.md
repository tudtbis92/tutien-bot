...
- **D-21 AMENDMENT (v3 deferral):** v3 delivers the free starter formation (11-02 seed) + shop purchase (`buyFormation` in 11-04) ONLY — formation SELL (no sell flow this phase) and the 'formations via boss drops' sourcing channel are deferred to a later phase; flagged in the 11-04 plan's flagged assumptions — not a silent drop.
